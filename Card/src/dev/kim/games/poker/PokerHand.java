...
public class PokerHand {
    ...
    public boolean equals(Object o) {
        ...
        if (playerNo != pokerHand.playerNo) return false;
        if (!Objects.equals(hand, pokerHand.hand)) return false;
        if (!Objects.equals(keepers, pokerHand.keepers)) return false;
        if (!Objects.equals(discards, pokerHand.discards)) return false;
        return score == pokerHand.score;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (discards != null ? discards.hashCode() : 0);
        result = 31 * result + (score != null ? score.hashCode() : 0);
        result = 31 * result + playerNo;
        return result;
    }
