...
//        readData(dataFile);
        ...
        Player kim = new Player(555, "Kim", 100_000_010,
                List.of("knife", "machete", "pistol"));
        System.out.println(kim);

        Path kimFile = Path.of("kim.dat");
//        writeObject(kimFile, kim);
        Player reconstitutedkim = readObject(kimFile);
        System.out.println(reconstitutedkim);
//
